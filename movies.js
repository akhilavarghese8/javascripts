...
// var mtitle=filims.map(m=>m.title)
// console.log(mtitle);

// print moviename whose genres comedy
var mcomedy=filims.filter(m=>m.genres.includes("Comedy")).map(m=>m.title)
console.log(mcomedy);

// print movie name runtime is greater>100
// var rfilter=filims.filter(m=>m.runtime>100).map(m=>m.title)
// filims.sort((m1,m2)=>m2.runtime-m1.runtime)
// console.log(filims);

// maximum runtime movie
var lengthymovie=filims.reduce((m1,m2)=>Number(m1.runtime)>Number(m2.runtime)?m1:m2)
